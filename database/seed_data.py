...
def seed_attribute_code_name(session):
    ...
    raw_data = [
        ...
        (27, 'DamageConditon'), (28, 'PollutionCondition'),
...
def seed_enum_value(session):
    ...
    raw_data = [
        ...
        (14, '养护车辆', '资源类型', 44, '2025-01-16 13:58:07', '2025-01-16 13:58:07'),
        (15, '交警', '资源类型', 44, '2025-01-16 13:58:19', '2025-01-16 13:58:19'),
        (16, '医生', '资源类型', 44, '2025-01-16 13:58:26', '2025-01-16 13:58:26'),
        (17, '路政人员', '资源类型', 44, '2025-01-16 13:58:35', '2025-01-16 13:58:35'),
        (18, '消防物资', '资源类型', 44, '2025-01-16 13:58:47', '2025-01-16 13:58:47'),
        (19, '危化处置物资', '资源类型', 44, '2025-01-16 13:58:56', '2025-01-16 13:58:56'),
        (20, '抢修物资', '资源类型', 44, '2025-01-16 13:59:04', '2025-01-16 13:59:04'),
...
def seed_template(session):
    ...
    raw_data = [
        ...
        (2, 2, 1, '道路承灾要素', '{"show": [{"aspect_type": "Affected"}], "create": {"entity_type": "Road", "category_type": ["AffectedElement", "EnvironmentElement"]}, "select": {"entity_type": "Road", "category_type": "AffectedElement"}}',
        ...
        (5, 2, 2, '道路环境要素', '{"show": [{"aspect_type": "Environment"}], "create": {"entity_type": "Road", "category_type": ["AffectedElement", "EnvironmentElement"]}, "select": {"entity_type": "Road", "category_type": "EnvironmentElement"}}',
...
def seed_template_behavior_definition(session):
    ...
    raw_data = [
        ...
        (4, 11), (8, 12), (8, 13), (8, 14), (8, 15), (8, 16), (8, 17),
    ]
...
def seed_attribute_definition(session):
    ...
    raw_data = [
        ...
        (39, '降雪强度', '降雪强度', 38, 4, 4, 0, 0, 0, None, None, '气象', '2025-01-15 11:32:39', '2025-01-15 11:32:39'),
        ...
        (55, '设施类型', '设施类型', 55, 4, 4, 1, 0, 0, None, '立柱', '基础设施', '2025-01-16 23:10:21', '2025-01-16 23:10:23'),
        (56, '设施位置', '设施位置', 56, 1, 4, 1, 0, 0, None, None, '基础设施', '2025-01-16 23:11:21', '2025-01-16 23:11:25'),
        (57, '受损情况', '受损情况', 57, 3, 4, 1, 0, 0, None, '0', '基础设施', '2025-03-01 23:12:06', '2025-01-16 23:12:09'),
        (58, '所属路段', '所属路段', 58, 6, 4, 1, 0, 1, 2, None, '基础设施', '2025-01-16 23:12:48', '2025-01-16 23:12:51'),
        (59, '车道类型', '车道类型', 59, 1, 4, 1, 0, 0, None, None, '车道', '2025-01-20 19:14:23', '2025-01-20 19:14:25'),
        (60, '车道宽度', '车道宽度', 60, 2, 4, 0, 0, 0, None, None, '车道', '2025-01-20 19:15:17', '2025-01-20 19:15:18'),
        (61, '车行道设计车速', '车行道设计车速', 61, 2, 4, 0, 0, 0, None, None, '车道', '2025-01-20 19:16:08', '2025-01-20 19:16:10'),
        (62, '车行道车型限制', '车行道车型限制', 62, 3, 4, 1, 0, 0, None, '0', '车道', '2025-01-20 19:17:27', '2025-01-20 19:17:29'),
        (63, '封闭情况', '封闭情况', 63, 3, 4, 1, 0, 0, None, '0', '车道', '2025-01-20 19:18:11', '2025-01-20 19:18:14'),
        (64, '污染情况', '污染情况', 64, 3, 4, 1, 0, 0, None, '0', '车道', '2025-01-20 19:18:48', '2025-01-20 19:18:50'),
        (65, '所属路段', '所属路段', 65, 6, 4, 1, 0, 1, 2, None, '车道', '2025-01-20 19:19:34', '2025-01-20 19:19:36'),
        (66, '所含车辆', '所含车辆', 66, 5, 4, 1, 1, 1, 1, None, '车道', '2025-01-20 19:20:08', '2025-01-20 19:20:11'),
        (67, '部件类型', '部件类型', 67, 4, 4, 1, 0, 0, None, None, '车辆部件', '2025-01-20 19:29:10', '2025-01-20 19:29:13'),
        (68, '是否脱落', '是否脱落', 68, 3, 4, 1, 0, 0, None, '0', '车辆部件/承载物', '2025-01-20 19:29:58', '2025-01-20 19:30:00'),
        (69, '所属车辆', '所属车辆', 69, 6, 4, 1, 0, 1, 1, None, '车辆部件', '2025-01-20 19:30:41', '2025-01-20 19:30:44'),
        (70, '承载物类型', '承载物类型', 70, 4, 4, 1, 0, 0, None, None, '承载物', '2025-01-20 19:31:29', '2025-01-20 19:31:31'),
        (71, '所属车辆', '所属车辆', 71, 6, 4, 1, 0, 1, 1, None, '承载物', '2025-01-20 19:32:02', '2025-01-20 19:32:05'),
        (72, '预案名称', '预案名称', 72, 1, 4, 1, 0, 0, None, '默认预案', '应急预案', '2025-01-20 19:36:24', '2025-01-20 19:36:26'),
        (73, '包含资源', '包含资源', 73, 6, 4, 0, 1, 1, 4, None, '应急预案', '2025-01-20 19:37:37', '2025-01-20 19:37:39'),
        (74, '包含行动', '包含行动', 74, 6, 4, 0, 1, 1, 5, None, '应急预案', '2025-01-20 19:38:08', '2025-01-20 19:38:10'),
        (75, '资源位置', '资源位置', 75, 1, 4, 0, 0, 0, None, '未知', '应急资源', '2025-01-25 15:37:03', '2025-01-25 15:37:03'),
        (76, '致灾时段', '致灾时段', 76, 4, 1, 1, 0, 0,None, '上午', '车辆 - 致灾体专有', '2025-02-07 13:14:52', '2025-02-07 13:14:52'),
    ]
    objs = []
    for d in raw_data:
        (
...
def seed_behavior_definition(session):
    ...
    """
    raw_data = [
        (1, '车辆行驶', '车辆行驶', 1, 1, 2, 0, '车辆-共有', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (2, '车辆运载', '车辆运载', 2, 0, 7, 0, '车辆-共有', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (3, '车辆离开', '车辆离开', 3, 1, 2, 0, '车辆-共有', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (4, '车辆燃爆', '车辆燃爆', 4, 1, 2, 0, '车辆-共有', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (5, '车辆抛洒', '车辆抛洒', 5, 1, 2, 0, '车辆-共有', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (6, '车辆侧翻', '车辆侧翻', 6, 1, 2, 0, '车辆-致灾体专有', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (7, '车辆抛锚', '车辆抛锚', 7, 1, 2, 0, '车辆-致灾体专有', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (8, '车辆撞击', '车辆撞击', 8, 1, 2, 0, '车辆-致灾体专有', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (9, '车辆转向', '车辆转向', 9, 1, 2, 0, '车辆-共有', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (10, '车辆变道', '车辆变道', 10, 1, 2, 0, '车辆-共有', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (11, '车辆变速', '车辆变速', 11, 1, 2, 0, '车辆-共有', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (12, '消防', '消防', 12, 1, 7, 0, '应急行为', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (13, '人员救护', '人员救护', 13, 1, 7, 0, '应急行为', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (14, '车辆牵引', '车辆牵引', 14, 1, 7, 0, '应急行为', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (15, '路面清扫', '路面清扫', 15, 1, 7, 0, '应急行为', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (16, '道路抢修', '道路抢修', 16, 1, 7, 0, '应急行为', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (17, '道路管制', '道路管制', 17, 1, 7, 0, '应急行为', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
        (18, '危化品处置', '危化品处置', 18, 1, 7, 0, '应急行为', '2025-01-15 11:16:03', '2025-01-15 11:16:03'),
    ]
    objs = []
    for row in raw_data:
