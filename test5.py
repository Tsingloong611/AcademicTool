...
def main():
    """主函数，展示如何使用OWL解析器"""
    # 创建解析器实例
    parser = OWLParser(r"D:\PythonProjects\AcademicTool_PySide\Merge.owl")

    # 解析并导出JSON
    json_data = parser.export_json("ontology_structure.json")
    ...
    # 5. 导出文档
    parser.export_documentation("ontology_documentation.md")
